...
var SCHEMA = {
  ...
  /* pauta_semanal se quitó del SCHEMA el 31-ago-2026. La escriben tres sistemas
   * directos: el Google Ads Script (Google y Meta), WixReservasPauta (reservas) y
   * PosPauta (comensales y ticket). Ninguno pasa por esta API.
   * Estaba aquí era un agujero: upsert() escribe la fila completa del SCHEMA, así
   * que un POST parcial con {wk, mCosto} vaciaba gCosto, gClics, gImp y reservas.
   * Había evidencia de que eso estaba pasando. Sin esta línea, doGet y doPost
   * responden 'tab desconocida' y la pestaña solo se toca por sus dueños. */
