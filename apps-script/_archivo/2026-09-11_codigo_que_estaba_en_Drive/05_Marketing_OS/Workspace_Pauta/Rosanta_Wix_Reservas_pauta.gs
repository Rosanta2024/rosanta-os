 ...
 * Script). OJO: la columna comensalesReserva la crea la intranet — abre el
 * Dashboard de Pauta una vez antes del primer run; si falta, el script lo avisa
 * en el Log y escribe solo "reservas".
 *
...
function procesarSemana(wk) {
  ...
  var r = contarReservas(desde, hasta);
  if (r === null) { Logger.log('S' + wk + ': sin datos (revisa credenciales o permisos)'); return; }
