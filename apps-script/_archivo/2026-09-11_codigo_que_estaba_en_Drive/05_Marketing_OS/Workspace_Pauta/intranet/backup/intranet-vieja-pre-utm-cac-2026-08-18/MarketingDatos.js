...
var SCHEMA = {
  ...
  /* comensales/comensalesReserva/ticket van AL FINAL a propósito: mktRead mapea
     por posición y las 8 columnas originales ya existen en la Sheet en este orden. */
  pauta_semanal: ['wk','gCosto','gClics','gImp','mCosto','mAlcance','reservas','fecha_registro','comensales','comensalesReserva','ticket'],
...
function mktSheet_(tab) {
  ...
  if (tab === 'pauta_semanal') pautaEnsureCols_(sh); // auto-alta de comensales/comensalesReserva/ticket
  return sh;
}

/* Añade las columnas nuevas de pauta_semanal (comensales, comensalesReserva,
   ticket) sin tocar las filas de datos: solo escribe la fila 1 completa en el
