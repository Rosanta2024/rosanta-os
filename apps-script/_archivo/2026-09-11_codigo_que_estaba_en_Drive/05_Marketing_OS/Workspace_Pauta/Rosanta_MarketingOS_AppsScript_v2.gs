/**
 * ROSANTA MARKETING OS — Capa de datos + Webhook de carritos  · v2 (4-ago-2026)
 *
 ...
 *  2. Ejecuta cargarCalendario311() una vez desde el editor.
 *  3. Implementar > Gestionar implementaciones > lápiz > Versión: Nueva
 *     versión > Implementar. (Sin esto el Web App sigue con el código viejo.)
 *
 ...
 *
 * WEBHOOK DE CARRITOS (WIX/Make):  <URL /exec>?token=rosanta2026xy&hook=sontickets
...
var ROWS_311 = [
  ...
  { id:'cal-2026-08', date:'2026-08-04', title:'Opiniones honestas (reseñas de Google)', tipo:'COMUNIDAD', eje:'Comunidad', estado:'Lista', canal:'Instagram',
    notas:'PUBLICADA/PUBLICA HOY 4-ago (martes ancla): contenido ya producido. Estrena el eje de reseñas con el formato propio OPINIONES HONESTAS: carrusel con capturas reales de reseñas públicas de Google sobre fotos del lugar difuminadas. Decisión Juanma 4-ago: cero molestias al cliente, sin pedir video ni permiso (las reseñas son públicas). Cierre: "Vive lo que ellos vivieron. Reserva tu mesa." Concepto separado del carrusel del logro (cal-2026-11) por regla Andromeda. Nota pauta: si esta pieza se amplifica con inversión, ahí sí pedir permiso a los autores (política Meta de endosos).',
    hook:'Slide 1: portada "OPINIONES HONESTAS" con wordmark sobre foto del salón difuminada. Slide 2 inmediato: captura real de reseña 5 estrellas con nombre visible.',
    stdc:'Think', metrica:'Guardados + compartidos por alcance ≥ promedio del mes' },

  { id:'cal-2026-09', date:'2026-09-01', title:'Detrás de cámaras del huerto', tipo:'VALOR', eje:'Cocina con corazón', estado:'Idea', canal:'Instagram',
  ...
  { id:'cal-2026-10', date:'2026-09-04', title:'La carta se movió con la temporada', tipo:'VENTA', eje:'Gastrococtelería', estado:'Idea', canal:'Instagram',
  ...
  { id:'cal-2026-11', date:'', title:'4.9 con 401 reseñas (carrusel del logro)', tipo:'COMUNIDAD', eje:'Comunidad', estado:'Idea', canal:'Instagram',
    notas:'[Banco] Pieza FUERA del ciclo 3-1-1, sin fecha. Segundo concepto del eje de reseñas, separado de Opiniones Honestas (cal-2026-08): este cuenta EL LOGRO agregado (4.9 con 401) con material propio, jamás las mismas capturas. Para diversificación creativa el día que las reseñas se amplifiquen a pauta (regla Andromeda).',
...
var APRENDIZAJES_PANEL = [
  ...
  { id:'ap-2026-08-04b', fecha:'2026-08-04', fuente:'Panel de Asesores + decisión Juanma',
    hallazgo:'Reseñas = dos conceptos separados: carrusel OPINIONES HONESTAS con capturas públicas de Google (cal-2026-08, formato propio, sin molestar al cliente) y carrusel del logro 4.9 con 401 (cal-2026-11). Regla Andromeda: jamás el mismo material con otro gancho. Permiso a autores solo si la pieza va a pauta (política Meta de endosos).',
    accion:'Producir como materiales distintos. Queda descartado el video-testimonio con permiso.' }
];
...
/** Mapea un carrito de WIX/Make a la pestaña carritos (+ CAPI opcional). */
