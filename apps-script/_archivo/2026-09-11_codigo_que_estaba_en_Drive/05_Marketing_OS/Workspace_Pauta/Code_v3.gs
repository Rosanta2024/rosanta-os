 ...
 *  3. cargarCalendario311() ya se ejecutó el 4-ago. Solo re-ejecutar si se
 *     quiere recargar el ciclo; es seguro, hace upsert por id.
 *
...
var SCHEMA = {
  ...
  reservas:      ['id','fecha','nombre','email','telefono','personas','gasto','estado'],
