...
- ~~Probar el CRM con un enlace real de Gmail.~~ **HECHO el 12-sep-2026, verificado por Juanma:** abrió el CRM con el enlace personal de Jeffry (Gmail, `?u=`) y funciona. El CRM con token queda cerrado de punta a punta. La batería no alcanzaba para darlo por bueno: corre con la cuenta de Juanma, así que solo prueba que cada llamada lleva el token.
