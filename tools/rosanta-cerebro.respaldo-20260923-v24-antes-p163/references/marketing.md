...
- **Las reseñas de Google se responden automáticamente** por el panel de reseñas en Apps Script. **Nunca listarlas como pendiente, ni en el brief ni en ningún reporte.** De 4★ y 5★ publica solo; de 1★ a 3★ redacta y deja la respuesta en `PENDIENTE_APROBAR` para que Juanma apruebe. Estado real en la hoja `Rosanta - Control de Reseñas GBP` (`17VHTRhelYtEKXjkf4dckPRrAwjif8owu22OLMxBl9bo`), columna Estado; el correo de aviso de Google no dice si ya se respondió.
