...
allowed-tools:
  ...
  - AskUserQuestion
description: >-
  Critica a fondo una idea, plan, pitch, decisión o proyecto sin validar ni
  ...
  ciego), investiga fracasos reales si hay web, y entrega un veredicto franco
  con la lista priorizada de qué arreglar. Usar SIEMPRE que el usuario presente
  una idea/plan/inversión/estrategia y pida una opinión crítica, honesta o
  "real", o antes de comprometer tiempo, dinero o reputación — aunque no diga
  "abogado del diablo". Disparadores: "/abogado-del-diablo", "hazme pedazos
  esto", "critica sin filtros", "dime por qué va a fallar", "destruye este
  plan", "segunda opinión brutal", "pre-mortem", "devil's advocate", "red team
  this", "why will this fail". Ante la duda entre activarla o dar una respuesta
  amable, activarla.
---
...
Si hay acceso a búsqueda web, no opinar a ciegas: buscar **casos reales** de ideas
parecidas que fracasaron y por qué. Postmortems, cementerios de startups,
"shutdown" + el sector, cierres y pivotes. Citar lo que se encuentre. Un fracaso
documentado de un parecido vale más que cualquier advertencia genérica. Si no hay
herramientas, decirlo y razonar con patrones conocidos en vez de inventar fuentes.
